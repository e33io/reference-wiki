...
super+shift+Retur   Launch file manager
...
super+button1       Move active window
...
View the [~/.config/dk/sxhkdrc](https://github.com/e33io/opt-dots/blob/main/spectrwm/.config/dk/sxhkdrc) file to see all the configured keybindings that aren’t indicated in the box above
