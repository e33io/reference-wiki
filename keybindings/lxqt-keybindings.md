...
Go to, LXQt Configuration Center > Shortcut Keys (Global Actions Manager), and LXQt Configuration Center > Window Manager > Keyboard, to see all the configured keybindings that aren’t indicated in the box above
