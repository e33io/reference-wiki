...
View the [~/.config/i3/config](https://github.com/e33io/core/blob/main/.config/i3/config) file to see all the configured keybindings that aren’t indicated in the box above
