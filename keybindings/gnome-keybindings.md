...
Super+Alt+Right      Cycle through active windows
Super+Alt+Left       Cycle through active windows (reverse)
...
Alt+Tab              Switch active applications
Alt+Shift+Tab        Switch active applications (reverse)
Super+o              Show overview of open windows
Alt+Space            Show active window menu
Alt+Shift+Space      Show active application menu
Super+Shift+q        Close active window
Ctrl+n               Toggle notification message tray
